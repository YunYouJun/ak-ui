...
export const examples: ExampleDefinition[] = [
  ...
  { id: 'icon/basic', title: 'Interface icons', surface: 'plain', height: 240, sourceOpen: false },
  { id: 'icon/stuff', title: 'Material badges', surface: 'plain', height: 400, sourceOpen: false },
  { id: 'icon/actions', title: 'Icon actions', surface: 'dark', height: 210, sourceOpen: false },
  ...
  { id: 'media/layered', title: 'Independent photo arcs', surface: 'plain', height: 520 },
  { id: 'media/album', title: 'Album', surface: 'plain', height: 360 },
  { id: 'nav/basic', title: 'Link navigation', surface: 'dark', height: 330 },
  { id: 'nav/vertical', title: 'Content directory', surface: 'dark', height: 380 },
  { id: 'news-list/basic', title: 'News list', surface: 'dark', height: 650 },
  { id: 'news-list/empty', title: 'Empty news list', surface: 'dark', height: 180 },
  { id: 'notice/basic', title: 'Tactical notices', surface: 'plain', height: 380 },
  { id: 'object/preview', title: 'Cube preview', surface: 'dark', height: 480, sourceOpen: false },
