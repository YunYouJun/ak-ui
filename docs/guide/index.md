...
需要由 Agent 通过结构化消息生成界面时，可查看 [A2UI（实验）](/guide/a2ui)，了解协议适配与交互演示。
...
首页、接入指南、设计与开发指南及 Registry API 均有中文与 [English](/en/guide/) 对应页面。语言菜单优先打开当前页面的译文；尚无译文时返回目标语言首页。详细组件参考和全屏演示仍以中文为准，英文导航会标明这些中文入口。
