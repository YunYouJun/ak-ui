---
title: Playground
description: Explore the ak-ui terminal, artwork and depth controls, Vue components and A2UI experiment.
---

# Playground

Choose a demo to explore ak-ui layouts, states and interactions. To integrate it into a project, start with the [AI Skill](/en/guide/ai-skill). For individual component interfaces, browse the [component index](/en/components/).

## Terminal and artwork
...
## Components and generated interfaces
